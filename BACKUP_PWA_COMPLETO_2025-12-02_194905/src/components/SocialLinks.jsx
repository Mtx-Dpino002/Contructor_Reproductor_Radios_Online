...
function SocialLinks({ config, onChange }) {
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-gray-400 mb-4">
        Agrega las URLs de tus redes sociales. Solo se mostrarán las que completes.
      </p>
      ...
      <div>
        <label className="block text-sm font-semibold text-gray-300 mb-2 flex items-center">
          <svg className="w-4 h-4 mr-2 text-gray-200" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => handleInputChange('socialTelegram', e.target.value)}
